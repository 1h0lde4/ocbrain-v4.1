...
InspectionPlanId = NewType("InspectionPlanId", str)
InspectionStepId = NewType("InspectionStepId", str)
...
VerificationMethodId = NewType("VerificationMethodId", str)
VerificationCapabilityId = NewType("VerificationCapabilityId", str)
CompiledVerificationSpecificationId = NewType("CompiledVerificationSpecificationId", str)
