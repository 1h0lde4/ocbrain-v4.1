...
| ADR-KERNEL-05 | Verifiable Hypothesis Provenance (CTX-AUTH-001b / DEBT-019) -- Option A (verified citation) selected, fail-closed, authority inherited never inferred; Option C retained as escalation path, Option B rejected. Design accepted; CTX-AUTH-001b itself stays open until implemented | Accepted (mechanism decided; implementation pending -- see ADR §7) | `ADR_KERNEL_05_VERIFIABLE_HYPOTHESIS_PROVENANCE.md` |
